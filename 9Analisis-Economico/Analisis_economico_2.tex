...
%La estimación total del costo se observa en la Tabla \ref{tab:costo-promedio-iptv} :
%
%
%
%
...
%    \hline
%    \end{tabular}%
%      \caption{Costo promedio de SDTV,HDTV.}
%  \label{tab:costo-promedio-iptv}%
%\end{table}%
...
%La estimación total del costo se observa en la Tabla \ref{tab:costo-promedio-voip} :
%
%
%
%
...
%\cline{1-2}    \rowcolor[rgb]{ .773,  .851,  .945} \multicolumn{1}{|c|}{\textbf{Tipo de trafico}} & \textbf{Magnitud Mbps} & \textbf{Costo US\$} \bigstrut\\
%    \hline
%    \multicolumn{1}{|c|}{Servicio VoIP} & 1,83  & 20,185 \bigstrut\\
%    \hline
%    \rowcolor[rgb]{ .773,  .851,  .945} \multicolumn{2}{|c|}{\textbf{Total}} & \textbf{20,185} \bigstrut\\
%    \hline
%    \rowcolor[rgb]{ .773,  .851,  .945} \multicolumn{2}{|c|}{\textbf{Costo x cliente}} & \textbf{0,331} \bigstrut\\
%    \hline
%    \end{tabular}%
%      \caption{Costo promedio VoIP.}
%  \label{tab:costo-promedio-voip}%
%\end{table}%
